...
```{r prompt-recipe-card-figure, echo=FALSE, fig.cap="Prompt recipe card for inquiry and synthesis. A structured prompt clarifies context, task, constraints, format, and uncertainty while preserving human review and accountability.", out.width="100%", fig.align="center", fig.pos='H'}
