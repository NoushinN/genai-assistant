...
Importantly, this stage should also include reflection on what the framing may exclude. Analysts should ask:
> What assumptions, perspectives, or contextual dimensions may have been unintentionally narrowed or omitted?
...
## Stage 3: Reasoning and uncertainty
...
## Stage 4: Sign-off and disclosure
...
At this stage, the central question is no longer:
> “Was AI used?”

but rather:
> “Does responsibility for the final analytical product remain clearly human?”

Analysts should remain able to:
- explain conclusions,
- defend reasoning,
- justify framing choices,
- and account for uncertainty independently of the AI system.
