...
```{r failure-modes-map-figure, echo=FALSE, fig.cap="Common failure modes in AI‑assisted policy and health analytics and corresponding mitigation practices. Most risks arise from under‑review rather than misuse.", out.width="100%", fig.align="center"}
knitr::include_graphics("failure_modes_map.png")
```
