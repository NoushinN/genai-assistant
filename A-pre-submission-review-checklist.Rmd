...
```{r checklist-workflow-alignment-figure, echo=FALSE, fig.cap="Alignment between workflow stages, checklist review focus, and the failure modes each review stage is intended to mitigate. The checklist operationalizes review discipline, evidence traceability, and governance boundaries across the lifecycle of AI-assisted analytical work.", out.width="100%", fig.align="center"}
knitr::include_graphics("figures/06_checklist_workflow_alignment.png")
```
