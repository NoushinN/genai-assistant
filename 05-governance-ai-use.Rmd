...
```{r governance-boundary-figure, echo=FALSE, fig.cap="Governance boundary for AI‑assisted analysis. Generative AI may support framing, drafting, and review, but must not cross into evidence generation, validation, or decision‑making.", out.width="90%", fig.align="center"}
knitr::include_graphics("governance_boundary.png")
```
