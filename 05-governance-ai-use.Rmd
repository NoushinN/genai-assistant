...
```{r governance-boundary-figure, echo=FALSE, fig.cap="Panel (a) illustrates governance boundaries for AI-assisted analysis, distinguishing acceptable, conditional, and non-delegable uses of generative AI. Panel (b) illustrates a governance escalation ladder showing how review expectations, documentation, and human accountability increase as analytical impact rises.", out.width="100%", fig.align="center", fig.pos='H'}
